...
public final class Constants {
  ...
  public static class ARM_ROTATION{
    ...
    public static final int  ARM_ROTATION_STALL_AMP_LIMIT = 30;
    public static final int ARM_ROTATION_FREE_AMP_LIMIT = 20;
  ...
  public static class ARM_EXTENSION{
    ...
    public static final int  ARM_EXTENSION_STALL_AMP_LIMIT = 30;
    public static final int ARM_EXTENSION_FREE_AMP_LIMIT = 20;
  }
